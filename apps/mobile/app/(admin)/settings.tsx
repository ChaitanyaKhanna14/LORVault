    ...
    >
      <Card>
        <View style={{ alignItems: 'center', paddingVertical: spacing.md }}>
          <View style={{ width: 64, height: 64, borderRadius: 32, backgroundColor: colors.primaryContainer, alignItems: 'center', justifyContent: 'center', marginBottom: spacing.sm }}>
            <Text style={{ ...typography.headlineLg, color: colors.primary }}>{user?.fullName?.charAt(0)?.toUpperCase() || '?'}</Text>
          </View>
          ...
          <View style={{ backgroundColor: colors.primaryContainer, paddingHorizontal: 12, paddingVertical: 4, borderRadius: radius.full, marginTop: spacing.xs }}>
            <Text style={{ ...typography.labelSm, color: colors.primary }}>ADMIN</Text>
          </View>
        </View>
      </Card>
