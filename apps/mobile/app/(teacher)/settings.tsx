...
export default function TeacherSettings() {
  ...
  return (
    ...
    >
      ...
      <Card>
        <Text style={{ ...typography.titleSm, color: colors.onSurface, marginBottom: spacing.md }}>
          Theme
        </Text>
        <View
          style={{
            ...
            return (
              <TouchableOpacity
                ...
                style={{
                  ...
                  backgroundColor: isActive ? colors.surfaceContainerLowest : 'transparent',
                  alignItems: 'center',
                  flexDirection: 'row',
                  justifyContent: 'center',
                  gap: 6,
                  ...(isActive ? { shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 3, elevation: 2 } : {}),
                }}
                activeOpacity={0.7}
              >
                <Ionicons name={option.icon as any} size={16} color={isActive ? colors.onSurface : colors.onSurfaceVariant} />
                <Text style={{ ...typography.labelLg, color: isActive ? colors.onSurface : colors.onSurfaceVariant }}>
                  {option.label}
                </Text>
              </TouchableOpacity>
            );
      ...
      <Text style={{ ...typography.bodySm, color: colors.outlineVariant, textAlign: 'center', marginTop: spacing['2xl'] }}>
        LORVault v1.0.0
      </Text>
    </ScrollView>
  );
