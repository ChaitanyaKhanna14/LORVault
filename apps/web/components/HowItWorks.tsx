  ...
  const steps = [
    {
      ...
      description: 'Upload the PDF document or scan the QR code on the letter',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Instant Check',
      description: 'We verify against our secure blockchain-backed database',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Get Results',
      description: 'See instant verification status with document details',
    },
  ];
